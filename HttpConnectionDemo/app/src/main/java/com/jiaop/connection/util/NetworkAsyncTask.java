package com.jiaop.connection.util;
...
/**
 * 连接服务器,获取数据
 * 使用时,修改conn.setRequestProperty()为需求的请求头
 */
public class NetworkAsyncTask extends AsyncTask<String, Integer, String> {
     ...
     * 有参构造函数
     * @param urlStr    服务器地址
     * @param method    请求方式POST or GET
     * @param authorization 请求头参数数据
     * @param params    参数
     * @param handler   接收返回结果
     * @param index 设置handler的what
     */
